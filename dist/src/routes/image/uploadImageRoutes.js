...
const upoadImages_1 = require("../../constrolers/person/upoadImages");
exports.default = (0, fastify_plugin_1.default)((fastify) => __awaiter(void 0, void 0, void 0, function* () {
    fastify.post("/persons/images", {
        schema: {
            response: {
                200: (0, uploadPersonImageSchema_1.$ref)("uploadPersonImageResponse"),
            },
        },
    }, upoadImages_1.uploadImages);
}));
